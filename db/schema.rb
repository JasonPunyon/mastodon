...
ActiveRecord::Schema[7.1].define(version: 2024_02_22_203722) do
  ...
  create_table "notification_policies", force: :cascade do |t|
    t.bigint "account_id", null: false
    t.boolean "filter_everyone", default: false, null: false
  ...
  create_table "user_agreements", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["terms_of_service_id", "user_id"], name: "index_user_agreements_on_terms_of_service_id_and_user_id", unique: true
  ...
  add_foreign_key "user_agreements", "terms_of_services"
